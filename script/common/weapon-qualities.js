...
//   descKey:      i18n key for the rulebook description shown in hover tooltips
//                 (parallel to labelKey: WEAPON_QUALITY.X -> WEAPON_QUALITY_DESC.X).
...
export const WEAPON_QUALITIES = {
    accurate: { labelKey: "WEAPON_QUALITY.ACCURATE", descKey: "WEAPON_QUALITY_DESC.ACCURATE", hasValue: false, trait: "accurate" },
    balanced: { labelKey: "WEAPON_QUALITY.BALANCED", descKey: "WEAPON_QUALITY_DESC.BALANCED", hasValue: false, trait: null },
    blast: { labelKey: "WEAPON_QUALITY.BLAST", descKey: "WEAPON_QUALITY_DESC.BLAST", hasValue: true, default: 1, trait: null },
    concussive: { labelKey: "WEAPON_QUALITY.CONCUSSIVE", descKey: "WEAPON_QUALITY_DESC.CONCUSSIVE", hasValue: true, default: 1, trait: null },
    corrosive: { labelKey: "WEAPON_QUALITY.CORROSIVE", descKey: "WEAPON_QUALITY_DESC.CORROSIVE", hasValue: false, trait: null },
    crippling: { labelKey: "WEAPON_QUALITY.CRIPPLING", descKey: "WEAPON_QUALITY_DESC.CRIPPLING", hasValue: true, default: 1, trait: null },
    defensive: { labelKey: "WEAPON_QUALITY.DEFENSIVE", descKey: "WEAPON_QUALITY_DESC.DEFENSIVE", hasValue: false, trait: null },
    felling: { labelKey: "WEAPON_QUALITY.FELLING", descKey: "WEAPON_QUALITY_DESC.FELLING", hasValue: true, default: 1, trait: null },
    flame: { labelKey: "WEAPON_QUALITY.FLAME", descKey: "WEAPON_QUALITY_DESC.FLAME", hasValue: false, trait: null },
    flexible: { labelKey: "WEAPON_QUALITY.FLEXIBLE", descKey: "WEAPON_QUALITY_DESC.FLEXIBLE", hasValue: false, trait: null },
    force: { labelKey: "WEAPON_QUALITY.FORCE", descKey: "WEAPON_QUALITY_DESC.FORCE", hasValue: false, trait: "force" },
    graviton: { labelKey: "WEAPON_QUALITY.GRAVITON", descKey: "WEAPON_QUALITY_DESC.GRAVITON", hasValue: false, trait: null },
    hallucinogenic: { labelKey: "WEAPON_QUALITY.HALLUCINOGENIC", descKey: "WEAPON_QUALITY_DESC.HALLUCINOGENIC", hasValue: true, default: 1, trait: null },
    haywire: { labelKey: "WEAPON_QUALITY.HAYWIRE", descKey: "WEAPON_QUALITY_DESC.HAYWIRE", hasValue: true, default: 1, trait: null },
    inaccurate: { labelKey: "WEAPON_QUALITY.INACCURATE", descKey: "WEAPON_QUALITY_DESC.INACCURATE", hasValue: false, trait: "inaccurate" },
    indirect: { labelKey: "WEAPON_QUALITY.INDIRECT", descKey: "WEAPON_QUALITY_DESC.INDIRECT", hasValue: true, default: 1, trait: null },
    lance: { labelKey: "WEAPON_QUALITY.LANCE", descKey: "WEAPON_QUALITY_DESC.LANCE", hasValue: false, trait: "lance" },
    maximal: { labelKey: "WEAPON_QUALITY.MAXIMAL", descKey: "WEAPON_QUALITY_DESC.MAXIMAL", hasValue: false, trait: "maximal" },
    melta: { labelKey: "WEAPON_QUALITY.MELTA", descKey: "WEAPON_QUALITY_DESC.MELTA", hasValue: false, trait: "melta" },
    overheats: { labelKey: "WEAPON_QUALITY.OVERHEATS", descKey: "WEAPON_QUALITY_DESC.OVERHEATS", hasValue: false, trait: "overheats" },
    powerField: { labelKey: "WEAPON_QUALITY.POWER_FIELD", descKey: "WEAPON_QUALITY_DESC.POWER_FIELD", hasValue: false, trait: null },
    primitive: { labelKey: "WEAPON_QUALITY.PRIMITIVE", descKey: "WEAPON_QUALITY_DESC.PRIMITIVE", hasValue: true, default: 7, trait: "primitive", numericTrait: true },
    proven: { labelKey: "WEAPON_QUALITY.PROVEN", descKey: "WEAPON_QUALITY_DESC.PROVEN", hasValue: true, default: 3, trait: "proven", numericTrait: true },
    razorSharp: { labelKey: "WEAPON_QUALITY.RAZOR_SHARP", descKey: "WEAPON_QUALITY_DESC.RAZOR_SHARP", hasValue: false, trait: "razorSharp" },
    recharge: { labelKey: "WEAPON_QUALITY.RECHARGE", descKey: "WEAPON_QUALITY_DESC.RECHARGE", hasValue: false, trait: null },
    reliable: { labelKey: "WEAPON_QUALITY.RELIABLE", descKey: "WEAPON_QUALITY_DESC.RELIABLE", hasValue: false, trait: "reliable" },
    sanctified: { labelKey: "WEAPON_QUALITY.SANCTIFIED", descKey: "WEAPON_QUALITY_DESC.SANCTIFIED", hasValue: false, trait: null },
    scatter: { labelKey: "WEAPON_QUALITY.SCATTER", descKey: "WEAPON_QUALITY_DESC.SCATTER", hasValue: false, trait: "scatter" },
    shocking: { labelKey: "WEAPON_QUALITY.SHOCKING", descKey: "WEAPON_QUALITY_DESC.SHOCKING", hasValue: false, trait: null },
    smoke: { labelKey: "WEAPON_QUALITY.SMOKE", descKey: "WEAPON_QUALITY_DESC.SMOKE", hasValue: true, default: 1, trait: null },
    snare: { labelKey: "WEAPON_QUALITY.SNARE", descKey: "WEAPON_QUALITY_DESC.SNARE", hasValue: true, default: 1, trait: null },
    spray: { labelKey: "WEAPON_QUALITY.SPRAY", descKey: "WEAPON_QUALITY_DESC.SPRAY", hasValue: false, trait: "spray" },
    storm: { labelKey: "WEAPON_QUALITY.STORM", descKey: "WEAPON_QUALITY_DESC.STORM", hasValue: false, trait: "storm" },
    tearing: { labelKey: "WEAPON_QUALITY.TEARING", descKey: "WEAPON_QUALITY_DESC.TEARING", hasValue: false, trait: "tearing" },
    toxic: { labelKey: "WEAPON_QUALITY.TOXIC", descKey: "WEAPON_QUALITY_DESC.TOXIC", hasValue: true, default: 1, trait: null },
    twinLinked: { labelKey: "WEAPON_QUALITY.TWIN_LINKED", descKey: "WEAPON_QUALITY_DESC.TWIN_LINKED", hasValue: false, trait: "twinLinked" },
    unbalanced: { labelKey: "WEAPON_QUALITY.UNBALANCED", descKey: "WEAPON_QUALITY_DESC.UNBALANCED", hasValue: false, trait: null },
    unreliable: { labelKey: "WEAPON_QUALITY.UNRELIABLE", descKey: "WEAPON_QUALITY_DESC.UNRELIABLE", hasValue: false, trait: "unreliable" },
    unwieldy: { labelKey: "WEAPON_QUALITY.UNWIELDY", descKey: "WEAPON_QUALITY_DESC.UNWIELDY", hasValue: false, trait: null },
    vengeful: { labelKey: "WEAPON_QUALITY.VENGEFUL", descKey: "WEAPON_QUALITY_DESC.VENGEFUL", hasValue: true, default: 9, trait: "rfFace", numericTrait: true }
};
